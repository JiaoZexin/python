...
def get_url():
    ...
    weather_url="http://www.weather.com.cn/weather/101301103.shtml"#%city_num
    return weather_url
...
def get_data(html_txt):#从网页中获取结果
    final=[]
    bs=a(html_txt,"html.parser")   #创建BeautifulSoup对象
